          ...
          children: [
            TextButton(
              ...
              onPressed: () {
                Navigator.push(
                  context,
                  CupertinoPageRoute(builder: (context) => const OfflinePage(page: 'offline',)),
                );
              },
            ...
            TextButton(
              ...
              onPressed: () {
                Navigator.push(
                  context,
                  CupertinoPageRoute(builder: (context) => const UserPlaylistsPage()),
                );
              },
            ...
            TextButton(
              ...
              onPressed: () {
                Navigator.push(
                  context,
                  CupertinoPageRoute(builder: (context) => const FavoritePage(page: 'liked',)),
                );
              },
            ...
            TextButton(
              ...
              onPressed: () {
                Navigator.push(
                  context,
                  CupertinoPageRoute(builder: (context) => const UserLikedPlaylistsPage()),
                );
              },
